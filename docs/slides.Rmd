...
.center[
<img src="../img/multilex.png" alt="multilex" width="100px"/>
]
]
...
```{r post-preds-item-casa, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r diagnostics-neffs, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, dpi=1000, out.width="90%", out.height="80%", fig.height=4, fig.width=10}
neffs %>% 
    ggplot() +
    aes(
        x = .neff
...
```{r rand-coefs, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, dpi=1000, out.width="90%", fig.height=4.5, fig.width=10}
...
```{r agradecimientos, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, out.height="100%", out.width="100%", dpi=3000}

knitr::include_graphics("../img/agradecimientos.jpg")
