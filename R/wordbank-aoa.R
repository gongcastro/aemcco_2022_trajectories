# this code was copy-pasted and adapted from https://mikabr.io/aoa-prediction/aoa_estimation.html
...
aoa_data <- all_prop_data %>%
    ...
    mean_qi(aoa, .width = c(0.50, 0.67, 0.89, 0.95)) %>% 
    ungroup() 

write_ipc_stream(aoa_data, here("data", "wordbank-aoa.parquet"))
